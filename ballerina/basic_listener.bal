...
public class BasicListener {
    ...
    private BasicDispatcherService dispatcherService;
    ...
    public function init(int|http:Listener listenTo, ServerConfiguration serverConfigs, *ListenerConfiguration config) returns error? {
        ...
        self.dispatcherService = basicDispatcherService;
    ...
    public isolated function attach(BasicMcpService basicMcpService, string[]|string? name = ()) returns error? {
        check self.httpListener.attach(self.dispatcherService, name);
        self.dispatcherService.addServiceRef(basicMcpService);
    }
    ...
    public isolated function detach(BasicMcpService basicMcpService) returns error? {
