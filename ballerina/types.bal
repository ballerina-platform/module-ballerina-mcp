...
public type ToolExecution record {|
    ...
    # Default: "forbidden"
    "forbidden"|"optional"|"required" taskSupport?;
|};
...
public type CallToolParams record {|
    *RequestParams;
    ...
    # The request will return a CreateTaskResult immediately.
    TaskMetadata task?;
|};
...
# Represents the lifecycle status of an MCP task.
public type TaskStatus "working"|"input_required"|"completed"|"failed"|"cancelled";
...
public type Task record {
    ...
    int pollInterval?;
    # Time-to-live in milliseconds for the task; null indicates unlimited retention
    int? ttl;
