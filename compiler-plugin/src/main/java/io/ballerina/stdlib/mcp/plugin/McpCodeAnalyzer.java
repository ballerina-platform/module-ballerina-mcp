...
/**
 * Registers the {@link OpenAPIGenerator} analysis task against service declarations so that an OpenAPI
 * contract is emitted for every {@code mcp:Service} when {@code --export-openapi} is enabled.
 */
